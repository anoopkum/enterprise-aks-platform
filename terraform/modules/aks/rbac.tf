...
resource "azurerm_role_assignment" "acr_pull" {
  count = var.acr_id != null && var.kubelet_identity_object_id != null ? 1 : 0
...
resource "azurerm_role_assignment" "private_dns_contributor" {
  count = var.private_cluster_enabled && var.private_dns_zone_id != null && var.identity_type == "UserAssigned" ? 1 : 0
